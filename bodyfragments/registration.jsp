             ...
             <div class="row">
               <div class="col-md-6 mb-4 d-flex align-items-center">
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <h6 class="mb-2 pb-1">UNT Status: </h6>
                  <s:bind path="gender">
                  ...
                  <div class="form-check form-check-inline">
                    ...
                    <label class="form-check-label" for="maleGender">Faculty</label>
                  </div>
                ...
                <div class="col-md-6 mb-4 pb-2">
                 <s:bind path="phoneNumber">
                  ...
                  <font color="red" style="font-size: 15px"><sf:errors path="${status.expression}" /></font>
                    ...
                    <label class="form-label" for="phoneNumber">License Plate</label>
                  </div>
					</s:bind>
                </div> 
              </div>
  			...
  			<c:otherwise>
             <div class="mt-4 pt-2">
              <input id="myButton" class="btn btn-primary btn-lg" type="submit" value="Add" style="background-color: green;" />
